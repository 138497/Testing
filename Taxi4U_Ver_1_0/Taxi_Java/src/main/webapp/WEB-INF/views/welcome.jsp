...
.divtable {
    position:absolute;
    top:70px;
    left:35%; /* Positions 50% from right (right edge will be at center) */
...
<body class="bc" leftmargin="0" topmargin="0" rightmargin="0"
	...
	<div class="divtable" align="center" style="font-family:Verdana">	
		<img src="<c:url value='/resources/images/welcome2.jpg'/>" align="middle"/>
